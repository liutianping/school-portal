...
<script type="text/javascript" src="../../script/system/resource.js"></script>
    <table class="easyui-datagrid" title="" style="width:700px;height:250px"
            data-options="rownumbers:true,singleSelect:true,url:'${pageContext.request.contextPath}/system/role/queryResourceList.htm',toolbar:'#resTb'"
            fit="true" pagination="true" id="roleDg">
        <thead>
            <tr>
                <th data-options="field:'recourceId',width:80" sortable="true">资源id</th>
        ...
        <table>
           <tr>
              <td><select class="easyui-combobox" panelHeight="auto" style="width:200px" name="type" id="userType">
                ...
                <option value="2">资源编号</option>
                <option value="3">资源名称</option>
                <option value="4">资源url</option>
                <option value="5">顺序</option>
                <option value="6">状态</option>
                <option value="7">资源类型</option>
                <option value="8">父资源id</option>
              </select></td>
